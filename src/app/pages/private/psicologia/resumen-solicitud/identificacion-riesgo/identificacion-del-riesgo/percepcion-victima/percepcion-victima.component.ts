...
@Component({
  selector: 'app-percepcion-victima',
  templateUrl: './percepcion-victima.component.html',
  styleUrls: ['./percepcion-victima.component.scss'],
})
export class PercepcionVictimaComponent implements AfterViewInit {
  ...
  public tipos = [
    {
      id: 8,
      nombre: 'PERCEPCIÓN DE LA VÍCTIMA FRENTE AL RRIEGO DE LA VIOLENCIA',
    },
  ];
  ...
  ngAfterViewInit(): void {
    this.getListFormTipoViolencia(8);
  }
